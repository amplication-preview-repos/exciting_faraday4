...
export class DiscussionResolverBase {
  ...
  @graphql.ResolveField(() => Meme, {
    nullable: true,
    name: "meme",
  })
  async getMeme(@graphql.Parent() parent: Discussion): Promise<Meme | null> {
    const result = await this.service.getMeme(parent.id);
